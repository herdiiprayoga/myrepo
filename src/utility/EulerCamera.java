...
public final class EulerCamera implements Camera {
    ...
    private EulerCamera(EulerCamera.Builder builder) {
        this.x = builder.x;
        this.y = builder.y;
        this.z = builder.z;
    ...
    public static class Builder {
         ...
         * @return this
         */
        public EulerCamera.Builder setAspectRatio(float aspectRatio) {
            if (aspectRatio <= 0) {
                throw new IllegalArgumentException("aspectRatio " + aspectRatio + " was 0 or was smaller than 0");
            }
            this.aspectRatio = aspectRatio;
         ...
         */
        public EulerCamera.Builder setNearClippingPane(float nearClippingPane) {
         ...
         */
        public EulerCamera.Builder setFarClippingPane(float farClippingPane) {
         ...
         * @return this
         */
        public EulerCamera.Builder setFieldOfView(float fov) {
            this.fov = fov;
            return this;
        }
         ...
         * @return this
         */
        public EulerCamera.Builder setPosition(float x, float y, float z) {
            this.x = x;
            this.y = y;
            this.z = z;
            return this;
         ...
         * @param roll the rotation around the z-axis in degrees
         */
        public EulerCamera.Builder setRotation(float pitch, float yaw, float roll) {
            this.pitch = pitch;
            this.yaw = yaw;
            this.roll = roll;
            return this;
